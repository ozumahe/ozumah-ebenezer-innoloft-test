...
const DetailsSection: FC<Props> = ({
  data: { categories, businessModels, trl },
}: Props) => {
  ...
  return (
    <>
        ...
        <div className="grid lg:grid-cols-2 gap-[20px] mt-[30px]">
          ...
          <div>
            ...
            <div
              ...
              className="mt-[10px] cursor-pointer lg:mt-[20px] bg-[#E5E7EB] rounded-[8px] text-[14px] font-normal flex justify-center items-center text-[#6B7280] py-[5px] px-[14px]"
            >
              {trl.name}
            </div>
          </div>
      ...
      <EditTRLModal trlmodalRef={trlmodalRef} />
    </>
  );
};
